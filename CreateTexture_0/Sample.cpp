...
ID3D11Buffer*	Sample::CreateBuffer( UINT ByteWidth, UINT BindFlags, void** pAddress   )
{    
...
{     
    ...
    /*if (LoadTexture(L"bk.png"))wireframe.tga
    {
        return false;
    }*/
